...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -3735.895377186399; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 3602.1009488690165; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 56.681792017106886; // x position of the perpendicular encoder (in tick units)
    }
