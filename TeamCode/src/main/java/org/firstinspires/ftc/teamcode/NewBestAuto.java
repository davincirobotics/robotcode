        ...
        Actions.runBlocking(new SequentialAction(
                ...
                new ParallelAction(
                        ...
                        drive.actionBuilder(beginPose)
                                ...
                                .splineToConstantHeading(new Vector2d(0, 22), Math.toRadians(-90))
                                .build()
                ),
                ...
                new ParallelAction(
                        ...
                        lift.liftDown(),
                        drive.actionBuilder(new Pose2d(0, 22, Math.toRadians(-90)))
                                .setTangent(Math.toRadians(90))
                                ...
                                .setTangent(Math.toRadians(90))
                                .splineToConstantHeading(new Vector2d(-54, 64), Math.toRadians(-90))
                                .build()
                ),
                new ParallelAction(
                        pickup.specimenToHang(),//pickup 2nd
                        lift.liftUp(),
                        drive.actionBuilder(new Pose2d(-54, 64, Math.toRadians(-90)))
                ...
                new ParallelAction(
                        pickup.prepareForSpecimen(),
                        lift.liftDown(),
                        drive.actionBuilder(new Pose2d(0, -10, Math.toRadians(-90)))
                                //.strafeTo(new Vector2d(10, 50))
                                .setTangent(Math.toRadians(112))
                                .splineToConstantHeading(new Vector2d(-40, 94), Math.toRadians(90))
                                .build()
                ),
                new ParallelAction(
                        pickup.specimenToHang(),//pickup 3rd
                        lift.liftUp(),
                        drive.actionBuilder(new Pose2d(-40, 94, Math.toRadians(-90)))
                                .setTangent(Math.toRadians(-50))
                ...
                new ParallelAction(
                        pickup.prepareForSpecimen(),
                        lift.liftDown(),
                        drive.actionBuilder(new Pose2d(0    , 15, Math.toRadians(-90)))
